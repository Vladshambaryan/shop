...
class TestPurchaseFlowSunglasses:

    # Тестовые данные
    product_name = "Sunglasses"
    product_price = "$19.99"
    total_price = "$28.98"  # товар + доставка $8.99

    """Полный флоу покупки товара"""
    @pytest.mark.regression
    def test_complete_purchase_sunglasses(self, page, shop_url):
